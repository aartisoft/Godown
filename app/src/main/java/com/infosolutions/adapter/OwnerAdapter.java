...
public class OwnerAdapter extends RecyclerView.Adapter<OwnerAdapter.OwnerViewHolder>{
    ...
    public OwnerAdapter(Context context, List<OwnerModel> listOwner){
    ...
    public OwnerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = null;
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_owner_view, parent, false);
        ...
        try {
            switch (position){
                ...
                case 0:
                    ...
                    openingLayout(myViewHolder.tableOwner,ownerArray);
                    break;

                case 1:
                    holder.tvTitle.setText(album.getTile());
                    domesticLayout(myViewHolder.tableOwner, ownerArray);
                    break;

                case 2:
                    holder.tvTitle.setText(album.getTile());
                    commercialLayout(myViewHolder.tableOwner, ownerArray);
                    break;

                case 3:
                    holder.tvTitle.setText(album.getTile());
                    receiveLayout(myViewHolder.tableOwner, ownerArray);
                    break;

                case 4:
                    holder.tvTitle.setText(album.getTile());
                    sendingLayout(myViewHolder.tableOwner, ownerArray);
                    break;

                case 5:
                    holder.tvTitle.setText(album.getTile());
                    tvDetailLayout(myViewHolder.tableOwner, ownerArray);
                    break;

                case 6:
                    holder.tvTitle.setText(album.getTile());
                    closingLayout(myViewHolder.tableOwner, ownerArray);
                    break;

                case 7:
                    holder.tvTitle.setText(album.getTile());
                    otherLayout(myViewHolder.tableOwner, ownerArray);
                    break;
