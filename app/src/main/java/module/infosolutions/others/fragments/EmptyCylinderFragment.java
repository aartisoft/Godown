...
public class EmptyCylinderFragment extends Fragment {

    public EmptyCylinderFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.frag_empty_cylinder, container, false);
    ...
    private void btnClickHandler(){
        ...
        buttonLoadUsers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mCountAnimationTextView. setAnimationDuration(5000).countAnimation(0, 9999999);
